...
* --- Define Key Execution Parameters in Time Indeces -------------------------
    ...
    mSettings('schedule', 't_end') = 14*24; // Last time step to be included in the solve (may solve and output more time steps in case t_jump does not match)
*    mSettings('schedule', 't_end') = 8760; // Last time step to be included in the solve (may solve and output more time steps in case t_jump does not match)
    ...
    mSettings('schedule', 't_horizon') = 14*24;    // How many active time steps the solve contains (aggregation of time steps does not impact this, unless the aggregation does not match)
    mSettings('schedule', 't_jump') = 14*24;          // How many time steps the model rolls forward between each solve
...
* --- Define Time Step Intervals ----------------------------------------------
    ...
    mInterval('schedule', 'lastStepInIntervalBlock', 'c000') = 14*24;
